...
- README summary: Leakless technique in order to gain remote code execution via fake fastbins, the unsorted\_bin attack and relative overwrites.
- Core effect: leakless chain using fake fastbins, unsorted-bin attack, and relative overwrites.
- README applicability: `< 2.29`
- Solver window note: `2.23 -> 2.24`

## When To Consider It

- historical leakless exploitation with several primitives chained together.
...
- No material source differences appear across `2.23 -> 2.24` in the retained corpus.
- Treat it as one historical leakless multi-primitive chain.
