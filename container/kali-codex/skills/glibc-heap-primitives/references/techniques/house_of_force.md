...
- README summary: Exploiting the Top Chunk (Wilderness) header in order to get malloc to return a nearly-arbitrary pointer
- Core effect: top-chunk steering to force an allocation at a near-arbitrary address.
- README applicability: `< 2.29`
- Solver window note: `2.23 -> 2.27`

## When To Consider It

- historical top-size corruption.
...
- No material source differences appear across the retained `2.23 -> 2.27` corpus.
- Treat this as one historical top-chunk steering technique that only matters on old targets.

## Representative Source Code

- Representative version: `glibc 2.23`
