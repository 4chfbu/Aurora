...
- README summary: Exploiting the Top Chunk (Wilderness) in order to gain arbitrary code execution
- Core effect: top-chunk abuse leading to code execution through old allocator internals.
- README applicability: `< 2.26`
- Solver window note: `2.23` only in the corpus.`

## When To Consider It

- strictly historical targets.
...
- Only one retained source variant exists in the corpus: `glibc 2.23`.
- Treat it as a strictly historical reference rather than a cross-version family.
