...
- README summary: Exploit a UAF or double free to gain leakless control of the t-cache metadata and a leakless way to link libc in t-cache
- Core effect: leakless control of tcache metadata and leakless libc linking in tcache era.
- README applicability: `latest`
- Solver window note: `2.32 -> 2.41`

## When To Consider It

- UAF or double free with reach into modern tcache metadata.
...
- No material source differences appear across `2.32 -> 2.41` in the retained corpus.
- Treat it as one modern safe-linking-era technique with stable structure across the shipped examples.
