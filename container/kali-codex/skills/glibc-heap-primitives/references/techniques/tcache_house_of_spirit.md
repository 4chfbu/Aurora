...
- README summary: Frees a fake chunk to get malloc to return a nearly-arbitrary pointer.
- Core effect: same idea in tcache era.
- README applicability: `> 2.25`
- Solver window note: `2.27 -> 2.41`

## When To Consider It

- fake chunk acceptance under tcache rules.
...
- This is the tcache-native analogue of house of spirit.
- The family remains stable across the retained versions, with the main practical changes coming from later allocator hardening.
- On safe-linking-era targets, re-check whether fake-chunk acceptance alone is enough or whether pointer protection changes the finish.
