...
- README summary: A technique to hijack a thread's arena within 8 allocations
- Core effect: arena hijack within a small number of allocations.
- README applicability: `< 2.27`
- Solver window note: `2.23 -> 2.24`

## When To Consider It

- old allocator targets where thread arena control is plausible.
...
- 2.23 and 2.24 keep the same arena-hijack strategy.
- The visible source difference is offset retuning in allocator bookkeeping, notably the target offset used around the leaked arena state (`0xa40` becomes `0xa20`).
- This is an offset-adjustment variant, not a conceptual rewrite.

## Representative Source Code

- Representative version: `glibc 2.24`
