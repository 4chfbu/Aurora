...
- README summary: Decrypt the poisoned value in linked list to recover the actual pointer
- Core effect: recover the real pointer from a protected singly linked list entry.
- README applicability: `>= 2.32`
- Solver window note: `2.32 -> 2.41`

## When To Consider It

- leaked mangled tcache or fastbin pointers.
...
- All retained variants belong to the safe-linking era.
- The core task stays the same: recover real pointers from mangled list entries.
- Cross-version differences are minor compared with the conceptual jump introduced at 2.32.
