...
class Settings(BaseModel):
    ...
    worker_input_max_files: int = Field(default_factory=lambda: int(os.getenv("AURORA_WORKER_INPUT_MAX_FILES", "100")), ge=1)
    worker_input_max_bytes: int = Field(default_factory=lambda: int(os.getenv("AURORA_WORKER_INPUT_MAX_BYTES", str(64 * 1024 * 1024))), ge=1)
    ...
    tsecbench_retain_environment_for_continuation: bool = Field(default_factory=lambda: os.getenv("AURORA_TSECBENCH_RETAIN_ENVIRONMENT_FOR_CONTINUATION", "true").lower() in {"1", "true", "yes"})
