...
type ChallengeGroup = { id: string; name: string; status: string; current_item_id?: string; max_concurrent?: number; limits?: Record<string, unknown>; deadline_at?: string; created_at: string };
