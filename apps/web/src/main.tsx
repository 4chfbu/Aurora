...
type Blackboard = { project: Project; facts: Fact[]; intents: Intent[]; attempts: Attempt[]; artifacts: Artifact[]; findings: Finding[]; flag_candidates: FlagCandidate[]; workers: Worker[]; checkpoints: AttemptCheckpoint[] };
...
function App() {
  ...
  useEffect(() => { void loadProjects(); void loadGroups(); void loadNetworkProxy(); }, []);
